import{_ as i,o as a,c as n,aA as p}from"./chunks/framework.C1YcvURS.js";const g=JSON.parse('{"title":"Coordinate transformations","description":"","frontmatter":{},"headers":[],"relativePath":"source/utils/UnitSpherical/coordinate_transforms.md","filePath":"source/utils/UnitSpherical/coordinate_transforms.md","lastUpdated":null}'),t={name:"source/utils/UnitSpherical/coordinate_transforms.md"};function l(h,s,e,k,r,d){return a(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="Coordinate-transformations" tabindex="-1">Coordinate transformations <a class="header-anchor" href="#Coordinate-transformations" aria-label="Permalink to &quot;Coordinate transformations {#Coordinate-transformations}&quot;">​</a></h1><p>Coordinate transformations from lat/long to geographic and back</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;&quot;</span></span>
