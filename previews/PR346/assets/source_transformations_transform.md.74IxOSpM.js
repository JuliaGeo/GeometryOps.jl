import{_ as a,c as i,o as n,az as t}from"./chunks/framework.CTknZ2bf.js";const g=JSON.parse('{"title":"Transform","description":"","frontmatter":{},"headers":[],"relativePath":"source/transformations/transform.md","filePath":"source/transformations/transform.md","lastUpdated":null}'),e={name:"source/transformations/transform.md"};function l(p,s,h,r,k,o){return n(),i("div",null,[...s[0]||(s[0]=[t(`<h1 id="Transform" tabindex="-1">Transform <a class="header-anchor" href="#Transform" aria-label="Permalink to &quot;Transform {#Transform}&quot;">​</a></h1><p>Transform a geometry by applying some function to all the points, which are provided as StaticVectors (which math like <code>+</code>, <code>*</code>, etc. works on).</p><p>You can pass any function or object that takes an <code>SVector</code> and returns some GeoInterface-compatible point.</p><h2 id="Example" tabindex="-1">Example <a class="header-anchor" href="#Example" aria-label="Permalink to &quot;Example {#Example}&quot;">​</a></h2><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import GeoInterface as GI, GeometryOps as GO</span></span>
<span class="line"><span></span></span>
<span class="line"><span>geom = GI.Polygon([[(0,0), (1,0), (1,1), (0,1), (0,0)]])</span></span>
<span class="line"><span>geom2 = GO.transform(p -&gt; p .+ (1, 2), geom)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>using CairoMakie, GeoInterfaceMakie</span></span>
<span class="line"><span>poly([geom, geom2]; color = [:steelblue, :orange])</span></span></code></pre></div><p>This uses <code>apply</code>, so will work with any geometry, vector of geometries, table, etc.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;&quot;</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">With Rotations.jl you need to actually multiply the Rotation</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">        end</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    end</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><hr><p><em>This page was generated using <a href="https://github.com/fredrikekre/Literate.jl" target="_blank" rel="noreferrer">Literate.jl</a>.</em></p>`,9)])])}const F=a(e,[["render",l]]);export{g as __pageData,F as default};
