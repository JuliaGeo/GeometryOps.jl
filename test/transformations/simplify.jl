...
@testset "DouglasPeucker" begin
    ...
    for c in poly_coords
        ...
        @testset_implementations "Polygon coords match LibGEOS simplify" poly begin
    ...
    @testset_implementations "LineString coords match LibGEOS simplify" linestring begin
