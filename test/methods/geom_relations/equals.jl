...
# Same point --> equal
@test GO.equals(pt1, pt1) == LG.equals(pt1, pt1) == true
# Different point --> not equal
@test GO.equals(pt1, pt2) == LG.equals(pt1, pt2) == false
# Point cannot equal line -> not equal
@test GO.equals(pt3, l1) == LG.equals(pt3, l1) == false
# Line cannot equal point -> not equal
@test GO.equals(l1, pt3) == LG.equals(l1, pt3) == false
# Point cannot equal ring -> not equal
@test GO.equals(pt3, r1) == LG.equals(pt3, r1) == false
# Ring cannot equal point -> not equal
@test GO.equals(r1, pt3) == LG.equals(r1, pt3) == false
# Point cannot equal polygon -> not equal
@test GO.equals(p1, pt3) == LG.equals(p1, pt3) == false
# Polygon cannot equal point -> not equal
@test GO.equals(pt3, p1) == LG.equals(pt3, p1) == false

# # Line and Geometry
# Same line -> equals
@test GO.equals(l1, l1) == LG.equals(l1, l1) == true
# Line overlaps line edge and endpoint (nothing exterior) -> not equal
@test GO.equals(l1, l2) == LG.equals(l1, l2) == false
# Line segments both within other line segments -> doesn't touch
@test GO.equals(l1, l4) == LG.equals(l1, l4) == false
