...
@testset "Intersection_polygons" begin
    ...
    poly_4 = [(-0.3877415677821795, 4.820886659632285),
     ...
     # convex (low spikiness) but high irregularity
    ...
    @test compareGO_LG(poly_1, poly_2, 1e5)
    @test compareGO_LG(poly_3, poly_4, 1e5)
    @test compareGO_LG(poly_5, poly_6, 1e5)
    @test compareGO_LG(poly_7, poly_8, 1e5)
    @test compareGO_LG(poly_9, poly_10, 1e5)
    @test compareGO_LG(poly_1, poly_10, 1e5)
    @test compareGO_LG(poly_5, poly_7, 1e5)
    @test compareGO_LG(poly_4, poly_9, 1e5)
