# function compareGO_LG(p1,p2)
#     LG_p1p2 = LG.intersection(p1, p2)
#     GO_p1p2 = GO.intersection(p1, p2)
#     inter_Go = GI.Polygon(GO_p1p2)
#     return equals(inter_GO, LG_p1p2)
# end
...
#     # made with low spikiness so they are concave
#     # poly1 = [(4.526700198111509, 3.4853728532584696), (2.630732683726619, -4.126134282323841),
#     #  (-0.7638522032421201, -4.418734350277446), (-4.367920073785058, -0.2962672719707883),
#     #  (4.526700198111509, 3.4853728532584696)]

#     # poly2 = [(5.895141140952208, -0.8095078714426418), (2.8634927670695283, -4.625511746720306),
...
#     poly_1 = LG.Polygon([[[4.526700198111509, 3.4853728532584696], [2.630732683726619, -4.126134282323841],
#     [-0.7638522032421201, -4.418734350277446], [-4.367920073785058, -0.2962672719707883],
#     [4.526700198111509, 3.4853728532584696]]])

#     poly_2 = LG.Polygon([[[5.895141140952208, -0.8095078714426418], [2.8634927670695283, -4.625511746720306],
#     [-1.790623183259246, -4.138092164660989], [-3.9856656502985843, -0.5275687876429914],
#     [-2.554809853598822, 3.553455552936806], [1.1865909598835922, 4.984203644564732],
#     [5.895141140952208, -0.8095078714426418]]])

#     compareGO_LG(poly_1, poly_2)
